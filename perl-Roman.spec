...
%description
This package provides some functions which help conversion of numeric notation
between Roman and Arabic.

%description -l pl
Pakiet udostêpnia kilka funkcji które pomagaj± w konwersji numerycznych notacji
pomiêdzy liczbami rzymskimi a arabskimi.
